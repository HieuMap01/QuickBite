...
<head>
	...
	<link rel="icon" type="image/png" sizes="16x16"
		href="${classpath}/administrator/assets/images/favicon.png">
	<title>${title }</title>
	...
	<div id="main-wrapper" data-theme="light" data-layout="vertical"
		...
		<div class="page-wrapper">
			...
			<div class="container-fluid">
				...
				<!-- ============================================================== -->
				<!-- basic table -->
				<form action="${env }/admin/order-list" method="get">
												...
												<tbody>
													<c:forEach var="saleOrder" items="${saleOrders }"
														...
														<tr>
															...
															<td><a
																href="${env }/edit-product/${saleOrder.id }"
																role="button" class="btn btn-primary">Edit</a>
															<td><a
																href="${env }/delete-product/${saleOrder.id }"
